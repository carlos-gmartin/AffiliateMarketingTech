        ...
        <div>
            ...
            <div class="container my-10 mx-auto md:px-6">
                ...
                <div class="flex flex-col justify-center">
                    <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6x">Bug reporting</h1>
                    <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">If you encounter any bugs after our technical services, this is the form to contact us.</p>
                </div>
                <form>
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        <label for="note" class="block mb-2 text-sm font-medium text-[#1F2B37]">Bug issue encountered</label>
                    ...
                    <div class="mb-6">
                        <label for="bug_issue" class="block mb-2 text-sm font-medium text-[#1F2B37]">Bug issue encountered</label>
                        <input type="text" id="bug_issue" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#77F2A1]  block w-full p-2.5 " placeholder=""></input>
                    </div>
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Report Bug</button>
                </form>
            </div>
        </div>
    )
