        ...
        <div>
            ...
            <div class="container my-10 mx-auto md:px-6">
                ...
                <div class="flex flex-col justify-center">
                        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6x">Complete your registration.</h1>
                        <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">We will get in contact as soon as possible with you.</p>
                </div>
                <form>
                    <div class="mb-6">
